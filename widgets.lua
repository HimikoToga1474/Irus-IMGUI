...
return function(Iris: Types.Internal)
	...
	WindowLoad(Iris, widgets)

	MenuLoad(Iris, widgets)

	FormatLoad(Iris, widgets)

	TextLoad(Iris, widgets)
	ButtonLoad(Iris, widgets)
	CheckboxLoad(Iris, widgets)
	RadioLoad(Iris, widgets)

	TreeLoad(Iris, widgets)

	InputLoad(Iris, widgets)
	ComboLoad(Iris, widgets)
	PlotLoad(Iris, widgets)

	TableLoad(Iris, widgets)
end
